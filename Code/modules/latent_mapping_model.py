...
# Example usage of SpatialSelfAttention
...
class ResAttnUNet_DS(nn.Module):
    ...
    def forward(self, x) -> torch.Tensor:
        ...
        x2_2 = self.conv2_2(torch.cat([x2, x3_1], dim=1)) # x2_2.shape: (1, 64, 28, 28)
        x1_3 = self.conv1_3(torch.cat([x1, x2_2], dim=1)) # x1_3.shape: (1, 32, 28, 28)
        x0_4 = self.conv0_4(torch.cat([x0, x1_3], dim=1)) # x0_4.shape: (1, 32, 28, 28)
