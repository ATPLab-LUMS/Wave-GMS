...
# Purpose                   : Implements linear warmup with cosine annealing LR scheduler.
# Usage                     : from utils.lr_scheduler import LinearWarmupCosineAnnealingLR
#
...
class LinearWarmupCosineAnnealingLR(_LRScheduler):
    """
    Linear warmup for a few epochs, followed by cosine annealing decay.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            eta_min         : Minimum LR after annealing.
    ...
    def get_lr(self) -> List[float]:
        ...
        if not self._get_lr_called_within_step:
            warnings.warn(
                "Use `get_last_lr()` instead of calling get_lr() directly.",
                UserWarning,
            )
    ...
    def _get_closed_form_lr(self) -> List[float]:
        """Closed form solution for LR at given epoch."""
